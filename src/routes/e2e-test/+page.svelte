...
// Create artifact object for UnifiedSandpackRenderer
function createArtifactObject(content: string, type: 'react' | 'svelte'): any {
return {
type: type,
entryCode: content,
title: 'Test Artifact',
...
artifact={createArtifactObject(artifactContent, 'react')}
height="100%"
data-testid="react-artifact-renderer"
/>
{:else if artifactType === 'svelte' && PUBLIC_SVELTE_ARTIFACTS_ENABLED === 'true'}
<UnifiedSandpackRenderer
artifact={createArtifactObject(artifactContent, 'svelte')}
height="100%"
